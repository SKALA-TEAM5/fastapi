...
# [ 주요 클래스 정의 ]
#
# 1. ItemJudgment                          : 항목별 판정 결과 스키마
# 2. CategoryAuditResult                   : 카테고리별 감사 결과 스키마
# 3. AuditSourceSummary                    : 감사 출처(법령) 요약 스키마
# 4. CategoryAuditSummary                  : 카테고리 감사 요약 응답 스키마
# 5. UsageStatementValidatorRequest        : 전체 사용내역서 검증 요청 스키마
# 6. UsageStatementValidatorCategoryRequest: 단일 카테고리 검증 요청 스키마
# 7. ValidatorAuditResponse                : 최종 검증 감사 응답 스키마
# --------------------------------------------------------------------------
