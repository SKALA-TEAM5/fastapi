...
# 4. _synthesize_reason_with_llm()   : LLM을 이용한 감사 사유 텍스트 합성
# 5. _build_reason()                 : 최종 감사 사유 문자열 조립
# 6. _classify_reason_code()         : reason_code 분류 로직
# 7. _derive_reasoning_summary_for_law() : 법령별 출처 요지 추출
# --------------------------------------------------------------------------
