...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
산업안전관리비 AI 검증 시스템  —  matching_service.py  v2 (monthly 기준 통합본)

[통합 이력]
  구버전 일 단위 비교(matching_service.py, daily)와 월 단위 비교(matching_service.py)가
  분리돼 있었으나, 운영에서 사용하던 월 단위 버전을 정본으로 통합함.
  일 단위 비교 전략(정산 주기 기반 _which_cycle / _get_settlement_cycle / _date_gate_cycle /
  _last_weekday_of_month)은 제거됨.

[날짜 Gate 로직]
  · used_on 기준 '같은 연월'이면 통과
    월 경계(±GATE_DATE_BOUNDARY_DAYS일) 도 허용 (예: 12/31 ↔ 01/01)

[영수증 날짜 필드 이중 지원]
  · CLOVA 포맷 : receipt["payment"]["date"]
  · 통합 포맷   : receipt["date"]  (ReceiptOCRResponse)
  두 포맷 모두 자동 인식
