        ...
        master_rows.append(
            {
                ...
                "source_id": None,
                "source_name": "config/legal_rule_profiles.json",
...
def build_payload(outputs_dir: Path, rule_config_path: Path = Path("config/legal_rule_profiles.json")) -> dict:
    ...
    rule_entries = [
        ...
        *parse_commentary_qa_rules(
            Path(next(doc.source_path for doc in documents if doc.source_type == "commentary")),
            next(doc.source_id for doc in documents if doc.source_type == "commentary"),
        ),
...
def main() -> None:
    ...
    parser.add_argument("--rule-config-path", default="config/legal_rule_profiles.json")
