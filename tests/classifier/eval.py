...
def run_evaluation(
    cases_dir: str = "tests/classifier/cases",
    output_dir: str = "tests/classifier/output",
    verbose: bool = False,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cases", default="tests/classifier/cases")
    parser.add_argument("--output", default="tests/classifier/output")
